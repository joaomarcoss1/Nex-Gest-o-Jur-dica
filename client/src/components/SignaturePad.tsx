    ...
    <div className="rounded-2xl border bg-white overflow-hidden shadow-sm">
      <div className="px-4 py-3 border-b bg-slate-50 flex items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          <Button type="button" size="sm" variant="outline" onClick={setup}><RotateCcw className="w-4 h-4" /> Limpar</Button>
          <Button type="button" size="sm" onClick={salvar} disabled={empty} className="nex-gradient-premium text-white"><Save className="w-4 h-4" /> Salvar</Button>
        </div>
      </div>
      <canvas
        ref={canvasRef}
